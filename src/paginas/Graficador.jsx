    ...
    >
      ...
      <main className="flex-1 relative flex flex-col">
        ...
        >
          ...
          >
            ...
            {edges.map(edge => {
              ...
              const isCriticalEdge = !!resultEdge?.critical;
              const isHighlightedEdge = !!resultEdge?.highlighted;
              ...
              const edgeWidth = isHighlightedEdge || isCriticalEdge ? 4 : 2;
          ...
          {nodes.map(node => {
            ...
            return (
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid #d1d5db' }}>
          ...
          >
            ...
            >
              ...
              {edgeEditValue !== '' && isNaN(parseFloat(edgeEditValue)) && (
                <p style={{ margin: '0 0 12px', fontSize: '11px', color: '#f87171' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end', marginTop: '8px' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '8px 16px',
                    backgroundColor: edgeEditValue !== '' && !isNaN(parseFloat(edgeEditValue)) ? '#2563eb' : '#1e3a5f',
                    color: 'white',
                    border: 'none',
                    borderRadius: '8px',
                    cursor: edgeEditValue !== '' && !isNaN(parseFloat(edgeEditValue)) ? 'pointer' : 'not-allowed',
                    fontWeight: '600',
                    fontSize: '13px',
                    opacity: edgeEditValue !== '' && !isNaN(parseFloat(edgeEditValue)) ? 1 : 0.5
                  }}
                >
                  Confirmar
                </button>
        ...
        >
          ...
          {!hasWeights && (
            <span style={{ fontSize: '10px', opacity: 0.6, fontWeight: '400', textTransform: 'none', letterSpacing: 0 }}>
              (requiere pesos)
            </span>
          )}
        </button>
